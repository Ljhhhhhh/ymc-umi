export default [
  {
    ...
    routes: [
      ...
      { path: '/recharge', component: './recharge/recharge', title: '即时充值' },
      { path: '/recharge/coupon', component: './recharge/coupon', title: '优惠券' },
      { path: '/recharge/telphone', component: './recharge/telphone', title: '手机充值' },
      { path: '/recharge/tel-coupon', component: './recharge/tel-coupon', title: '优惠券' },
      { path: '/form/car', component: './form/car', title: '添加车辆' },
      {
        path: '/exception',
