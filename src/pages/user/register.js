...
const Register = props => {
  ...
  return (
    <div>
      <NavBar mode="light" icon={<GoBack />} rightContent={<Link to="/user/login">登录</Link>}>
        注册
      </NavBar>
      <LogoBox>
        <Logo />
        ...
        <InputItem
          ...
          extra={
            <InviteBtn
              ...
              fields="mobile"
              api="https://www.easy-mock.com/mock/5ca2128e0aa7bf50eb36bcc0/code"
            />
          }
        >
          <PngIcon width="36px" height="32px" icon="vefiry" />
        </InputItem>
        <InputItem {...getFieldProps('invite')} placeholder="请输入邀请人手机号(选填)" clear>
